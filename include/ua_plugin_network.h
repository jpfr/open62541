...
// TODO: This file is obsolete. Move declarations to other files.
...
struct UA_Connection_old;
typedef struct UA_Connection_old UA_Connection_old;
...
struct UA_Connection_old {
    ...
    UA_StatusCode (*getSendBuffer)(UA_Connection_old *connection, size_t length,
                                   UA_ByteString *buf);

    /* Release the send buffer manually */
    void (*releaseSendBuffer)(UA_Connection_old *connection, UA_ByteString *buf);
    ...
    UA_StatusCode (*send)(UA_Connection_old *connection, UA_ByteString *buf);
     ...
     *         closed. */
    UA_StatusCode (*recv)(UA_Connection_old *connection, UA_ByteString *response,
                          UA_UInt32 timeout);

    /* Release the buffer of a received message */
    void (*releaseRecvBuffer)(UA_Connection_old *connection, UA_ByteString *buf);
