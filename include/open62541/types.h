...
#define UA_UINT64_MIN 0ULL
#define UA_UINT64_MAX 18446744073709551615ULL
 ...
 * tagged pointer format. This saves space and improves speed. It is assumed
 * that pointers to the heap are aligned to the word-size. The lowest two bit of
 * the pointer are used for tagging.
 *
